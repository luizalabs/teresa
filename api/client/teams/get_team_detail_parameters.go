...
// NewGetTeamDetailParamsWithTimeout creates a new GetTeamDetailParams object
// with the default values initialized, and the ability to set a timeout on a request
func NewGetTeamDetailParamsWithTimeout(timeout time.Duration) *GetTeamDetailParams {
	var ()
	return &GetTeamDetailParams{
