...
type Options struct {
	...
	SlugBuilderImage     string        `split_words:"true" default:"luizalabs/slugbuilder:v3.3.0"`
	SlugRunnerImage      string        `split_words:"true" default:"luizalabs/slugrunner:v3.1.0"`
