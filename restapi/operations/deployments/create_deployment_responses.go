...
func (o *CreateDeploymentDefault) WithPayload(payload *models.GenericError) *CreateDeploymentDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create deployment default response
func (o *CreateDeploymentDefault) SetPayload(payload *models.GenericError) {
	o.Payload = payload
}
